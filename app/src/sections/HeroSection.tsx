        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="text-center lg:text-left">
            <div className="inline-flex items-center gap-2 bg-vet-green/10 text-vet-green px-4 py-2 rounded-full text-sm font-medium mb-6 animate-fade-in">
              ...
              Especialistas en rehabilitación animal
            </div>
            ...
            <p className="text-lg text-vet-gray-light leading-relaxed mb-8 max-w-xl mx-auto lg:mx-0 animate-fade-in" style={{ animationDelay: '200ms' }}>
              Recuperamos la movilidad y calidad de vida de tu compañero peludo con tratamientos personalizados, tecnología de vanguardia y un equipo de especialistas dedicados.
            </p>
            ...
            <div className="relative">
              ...
              <div className="relative bg-white rounded-[2.5rem] shadow-2xl overflow-hidden p-4">
                <div className="aspect-[4/3] rounded-[2rem] overflow-hidden bg-gradient-to-br from-vet-cream to-white flex items-center justify-center">
                  <div className="text-center p-8">
                    <div className="w-32 h-32 mx-auto mb-6 bg-gradient-to-br from-vet-green to-vet-blue rounded-full flex items-center justify-center shadow-xl animate-float">
                      <svg className="w-16 h-16 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/>
                      </svg>
                    </div>
                    <h3 className="font-display text-2xl font-bold text-vet-gray mb-2">Cuidado Profesional</h3>
              ...
              <div className="absolute -left-8 top-1/4 bg-white rounded-2xl shadow-xl p-4 animate-float" style={{ animationDelay: '0.5s' }}>
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 bg-vet-green/10 rounded-xl flex items-center justify-center">
                    <CheckCircle className="w-6 h-6 text-vet-green" />
                  </div>
                  <div>
                    <div className="font-semibold text-vet-gray">Certificados</div>
                    <div className="text-sm text-vet-gray-light">Profesionales</div>
                  </div>
                </div>
              </div>
              ...
              <div className="absolute -right-4 bottom-1/4 bg-white rounded-2xl shadow-xl p-4 animate-float" style={{ animationDelay: '1s' }}>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <div className="font-semibold text-vet-gray">Tecnología</div>
                    <div className="text-sm text-vet-gray-light">Avanzada</div>
                  </div>
                </div>
              </div>
            </div>
