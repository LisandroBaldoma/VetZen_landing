          ...
          <div>
            ...
            <div className="mt-10 p-6 bg-vet-cream rounded-2xl">
              ...
              <div className="flex flex-wrap gap-4">
                <a href="tel:+543412500570" className="inline-flex items-center gap-2 text-vet-green hover:underline">
                  <Phone className="w-5 h-5" />
                  +54 3412 500570
                </a>
                <a href="https://wa.me/543412500570" className="inline-flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-full text-sm hover:bg-green-600 transition-colors">
